...
- Спуститесь в самый низ файла и найдите строку, которую добавил скрипт. Она выглядит так:  `alias dns='~/scripts/dns.sh'`
- Просто замените слово dns перед знаком равно на вашу команду. Должно получиться, например, так:  `alias switchdns='~/scripts/dns.sh'`
