...
* **Сетевой менеджер:** Требуется **NetworkManager** (утилита `nmcli`). Это стандартный менеджер сети почти во всех современных десктопных дистрибутивах Linux (Ubuntu, Fedora, Arch, Linux Mint и др.).
